...
const Calculation = () => {
  ...
  const handleCalculation = () => {
    ...
    const CODShipping = (totalOrderNum * 70) * (1 - cancellationNum / 100) * (29 / 100);
    ...
    const TotalExp = TotalAdCost + GST + PrepaidShipping + CODShipping + LabourCost + FixCost + MaterialCost + Paymoney + InteractCharges;
